...
class Option:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument("--pretrain_path_allone", default="xxx", type=str, help="pretrain path all one")
        ...
        parser.add_argument('--freeze_layers', type=str, default="[conv]", help="List of layers")
    ...
    def print_options(self, opt):
        ...
        # expr_dir = os.path.join(opt.checkpoints_dir, f'{opt.organ}_{opt.model_depth}_2025')
        mkdirs(expr_dir)
        checkpoint_dir = os.path.join(expr_dir, str(opt.fold_index))
        mkdirs(checkpoint_dir)
        checkpoint_dir_auc = os.path.join(expr_dir, "auc")
        mkdirs(checkpoint_dir_auc)
        checkpoint_dir_f1 = os.path.join(expr_dir, "f1")
        mkdirs(checkpoint_dir_f1)
