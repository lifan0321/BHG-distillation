...
from datasets_all.GeneralDataset import TaskData
...
class SimpleDataModule():
    def __init__(self,
        ...
        self.ds_train = TaskData(nii_path, fold_path, 'train', aug, fold_index, seed)
        self.ds_val = TaskData(nii_path, fold_path, 'val', aug, fold_index, seed)
        self.ds_test = TaskData(nii_path, fold_path, 'test', aug, fold_index, seed)
